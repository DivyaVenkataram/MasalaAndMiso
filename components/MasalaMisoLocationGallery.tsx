...
export default function MasalaMisoLocationGallery() {
  ...
  return (
    <section
      className="relative min-h-screen overflow-hidden px-6 py-14 md:px-10 lg:px-16"
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col mx-auto max-w-[1500px] text-white">
        ...
        <div className="group relative flex min-h-0 flex-1 w-full max-w-[1380px] mx-auto">
          {/* Desktop: larger shapes, grid fills remaining height */}
          <div className="hidden h-full lg:grid lg:grid-cols-5 lg:grid-rows-[1fr] lg:gap-8 lg:flex-1 lg:min-h-0">
            {locations.map((location) => (
              <Link
                key={location.id}
                href={location.href}
                className={[
                  'group/item relative flex min-h-0 flex-col items-center transition-all duration-500 ease-out',
              ...
              >
                ...
                <div className="flex-shrink-0 mt-4 w-full text-center lg:mt-6">
                  <h3
                  ...
                  <p
                    className="mt-2 text-[11px] uppercase tracking-[0.33em] text-white/80"
                    style={{ fontFamily: '"Inter", sans-serif' }}
                  >
                    {location.sublabel}
                  </p>
          ...
          <div className="grid min-h-0 flex-1 grid-cols-1 gap-8 sm:grid-cols-2 lg:hidden">
            {locations.map((location) => (
              <Link
                key={location.id}
                href={location.href}
              ...
              >
                ...
                <div className="flex-shrink-0 mt-4 w-full text-center">
                  ...
                  <p
                    className="mt-2 text-[11px] uppercase tracking-[0.28em] text-white/80"
                    style={{ fontFamily: '"Inter", sans-serif' }}
                  >
                    {location.sublabel}
                  </p>
