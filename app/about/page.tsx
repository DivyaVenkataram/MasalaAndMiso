    ...
    <main>
      ...
      <div className="max-w-reading mx-auto px-8 py-24">
        <section className="mb-20">
          <h2 className="font-playfair text-2xl sm:text-3xl font-medium text-midnight mb-6 border-b border-midnight/20 pb-2 w-fit">
            Our Background
          </h2>
          <div className="space-y-6 text-midnight leading-relaxed">
            <p>
        ...
        <section className="mb-20">
          ...
          <blockquote className="pull-quote-editorial py-8">
        ...
        <section className="mb-20">
          ...
          <div className="flex flex-wrap gap-6 mb-6">
            {['Michelin Guide', 'Resy', 'Tock', 'American Express Dining'].map((name) => (
              <span
                key={name}
                className="text-midnight/60 text-sm uppercase tracking-widest border-b border-midnight/20 pb-1"
              >
                {name}
              </span>
            ))}
        ...
        <section className="mb-20">
          ...
          <div className="space-y-8">
            <blockquote className="border-l-2 border-wine/50 pl-6 text-midnight/85 italic">
